...
Use 6 menu items for utama, 4 for minuman, 4 for pencuci (14 total). Use 6 gallery items, 6 features, 6 testimonials. Use real Unsplash photo URLs (https://images.unsplash.com/photo-XXXX?w=800&q=80) relevant to the business type. All text in Bahasa Malaysia.`;

  const userMessage = `${prompt}

Generate the JSON content now. Return ONLY the JSON object.`;
