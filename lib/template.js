const PALETTES = {
  restaurant: { primary: '#e07856', primaryLight: '#f0977a', secondary: '#c2493a', accent: '#3d1f1a', bgLight: '#fdf8f5', gold: '#ffd700', paletteName: 'Terracotta Hangat' },
  cafe: { primary: '#a67c52', primaryLight: '#c09b76', secondary: '#6f4e37', accent: '#2f2119', bgLight: '#faf6f2', gold: '#ffd700', paletteName: 'Kopi Klasik' },
  bakery: { primary: '#d4a574', primaryLight: '#e6c19a', secondary: '#a6763e', accent: '#3e2c1e', bgLight: '#fdf9f4', gold: '#ffd700', paletteName: 'Butter Cream' },
  fashion: { primary: '#9370b8', primaryLight: '#b39ddb', secondary: '#6a4c93', accent: '#2d1b4e', bgLight: '#f8f6fc', gold: '#ffd700', paletteName: 'Lavender Elite' },
  salon: { primary: '#e58fb1', primaryLight: '#f2b3cc', secondary: '#c26b8f', accent: '#3d1f2e', bgLight: '#fdf5f8', gold: '#ffd700', paletteName: 'Rose Blush' },
  clinic: { primary: '#5dade2', primaryLight: '#85c1e9', secondary: '#3498db', accent: '#1b3c59', bgLight: '#f4f9fd', gold: '#ffd700', paletteName: 'Medical Blue' },
  tech: { primary: '#48c9b0', primaryLight: '#76d7c4', secondary: '#1abc9c', accent: '#0e2f2c', bgLight: '#f0faf8', gold: '#ffd700', paletteName: 'Mint Tech' },
  education: { primary: '#f5b041', primaryLight: '#f8c471', secondary: '#e67e22', accent: '#4a2f0e', bgLight: '#fdf9f0', gold: '#ffd700', paletteName: 'Sunrise Knowledge' },
  default: { primary: '#9393cd', primaryLight: '#b3b3e0', secondary: '#6e5298', accent: '#352040', bgLight: '#f8f7fc', gold: '#ffd700', paletteName: 'Modern Purple' },
};

const COLOR_STYLES = {
  hangat:    { primary: '#e07856', primaryLight: '#f0977a', secondary: '#c2493a', accent: '#3d1f1a', bgLight: '#fdf8f5', paletteName: 'Terracotta Hangat', desc: 'Warm & appetizing — sesuai F&B' },
  sejuk:     { primary: '#3498db', primaryLight: '#5dade2', secondary: '#2e86c1', accent: '#1b3c59', bgLight: '#f4f9fd', paletteName: 'Ocean Blue', desc: 'Profesional & dipercayai' },
  mewah:     { primary: '#c9a227', primaryLight: '#e3c565', secondary: '#9a7b1e', accent: '#2c2410', bgLight: '#fdfaf0', paletteName: 'Royal Gold', desc: 'Premium & eksklusif' },
  elegan:    { primary: '#8e44ad', primaryLight: '#a569bd', secondary: '#6c3483', accent: '#2d1b4e', bgLight: '#f9f4fc', paletteName: 'Amethyst', desc: 'Sofistikated & moden' },
  segar:     { primary: '#27ae60', primaryLight: '#58d68d', secondary: '#1e8449', accent: '#0e2f1c', bgLight: '#f0faf4', paletteName: 'Forest Green', desc: 'Natural & sihat' },
  berani:    { primary: '#e74c3c', primaryLight: '#f1948a', secondary: '#c0392b', accent: '#3d120c', bgLight: '#fdf4f2', paletteName: 'Sunset Red', desc: 'Energetik & berani' },
  lembut:    { primary: '#f5b7b1', primaryLight: '#f8d7d3', secondary: '#e6a19a', accent: '#4a2c29', bgLight: '#fef9f8', paletteName: 'Peach Soft', desc: 'Feminin & lembut' },
  gelap2:    { primary: '#2c3e50', primaryLight: '#4a6785', secondary: '#1a252f', accent: '#0d1319', bgLight: '#eef2f6', paletteName: 'Charcoal Pro', desc: 'Korporat & serius' },
  tropika:   { primary: '#16a085', primaryLight: '#45c4ab', secondary: '#107360', accent: '#0b3d33', bgLight: '#effaf7', paletteName: 'Tropical Teal', desc: 'Segar & santai' },
  manis:     { primary: '#d980fa', primaryLight: '#e5b3ff', secondary: '#a55eea', accent: '#35194f', bgLight: '#faf5fe', paletteName: 'Candy Pop', desc: 'Fun & muda' },
};
...
const THEMES = {
  modern: {
    label: 'Moden',
    fonts: { body: "'Poppins',sans-serif", head: "'Playfair Display',serif" },
    fontLinks: 'https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800;900&family=Playfair+Display:wght@600;700;800;900&display=swap',
    navbarBg: 'rgba(255,255,255,.85)',
    textDark: '#2a2030', textMuted: '#6b6373',
    heroOverlay: null,
    extraCss: '',
  },
  elegan: {
    label: 'Elegan',
    fonts: { body: "'Cormorant Garamond',serif", head: "'Cormorant Garamond',serif" },
    fontLinks: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Montserrat:wght@300;400;500;600&display=swap',
    navbarBg: 'rgba(255,253,248,.92)',
    textDark: '#2b2416', textMuted: '#7a6f58',
    heroOverlay: 'linear-gradient(180deg,rgba(43,36,22,.25),rgba(43,36,22,.65))',
    extraCss: `h1,h2,h3,h4,.logo-text strong,.signature-price,.menu-price,.hero-card-price,.about-floating strong{font-family:'Cormorant Garamond',serif;letter-spacing:.5px}
body,.section-header p,.about-content p,.menu-card p,.btn,.btn-order{font-family:'Montserrat',sans-serif}
.section{padding:110px 0}
.section-tag{letter-spacing:3px;font-size:11px}
.btn{border-radius:4px}
.btn-order{border-radius:4px}
.signature-card,.feature-card,.testimonial-card,.contact-card,.hero-card{border-radius:8px}
.menu-card{border-radius:8px}
.hero h1 span::after{height:2px;opacity:.8}
.about-feature{border-left:2px solid var(--gold)}`,
  },
  minimalis: {
    label: 'Minimalis',
    fonts: { body: "'Inter',sans-serif", head: "'Inter',sans-serif" },
    fontLinks: 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap',
    navbarBg: '#ffffff',
    textDark: '#111111', textMuted: '#666666',
    heroOverlay: 'linear-gradient(180deg,rgba(0,0,0,.35),rgba(0,0,0,.7))',
    extraCss: `h1,h2,h3,h4,.logo-text strong,.signature-price,.menu-price{font-family:'Inter',sans-serif;font-weight:700;letter-spacing:-.5px}
.section-tag{background:var(--accent);color:#fff}
.section{padding:90px 0}
.btn{border-radius:0}
.btn-order{border-radius:0}
.signature-card,.feature-card,.testimonial-card,.contact-card,.hero-card,.menu-card{border-radius:0;box-shadow:0 1px 3px rgba(0,0,0,.08)}
.signature-card:hover,.feature-card:hover{transform:none;box-shadow:0 3px 12px rgba(0,0,0,.12)}
.nav-menu a{border-radius:0}
.hero h1{font-weight:800}
.hero h1 span::after{display:none}
.hero h1 span{color:var(--gold)}
.about-floating{border-radius:0}
...
.footer-bottom{border-color:rgba(255,255,255,.15)}`,
  ...
  gelap: {
    label: 'Gelap',
    fonts: { body: "'Space Grotesk',sans-serif", head: "'Space Grotesk',sans-serif" },
    fontLinks: 'https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&display=swap',
    navbarBg: 'rgba(15,15,20,.9)',
    textDark: '#e8e8ec', textMuted: '#9a9aa5',
    heroOverlay: 'linear-gradient(180deg,rgba(8,8,12,.6),rgba(8,8,12,.85))',
    extraCss: `h1,h2,h3,h4,.logo-text strong,.signature-price,.menu-price{font-family:'Space Grotesk',sans-serif}
body{background:#0b0b10}
.section{background:#0b0b10}
.about,.menu,.features,.contact,.booking{background:#0b0b10}
.signature,.gallery{background:#101018}
.bg-white{background:#0b0b10!important}
.navbar{border-bottom:1px solid rgba(255,255,255,.08)}
.nav-menu a{color:#e8e8ec}
.logo-text strong{color:#fff}
.logo-text span{color:var(--gold)}
.about-content h2,.menu-card h3,.signature-card h3,.feature-card h3{color:#fff}
.about-content p,.menu-card p,.section-header p,.feature-card p,.booking-form>p{color:#9a9aa5}
.section-tag{background:var(--gold);color:#0b0b10}
.signature-card,.feature-card,.menu-card{background:#14141c}
.signature-card:hover,.feature-card:hover{background:#1a1a25}
.testimonial-card{background:rgba(255,255,255,.04)}
.about-feature{background:#14141c}
.btn-primary{color:#0b0b10}
.about-floating{background:#14141c}
.about-floating strong{color:#fff}
.about-floating span{color:#9a9aa5}
.form-group input,.form-group select,.form-group textarea{background:#14141c;color:#e8e8ec;border-color:#1a1a25}
.form-group input:focus{background:#1a1a25}
.booking-wrapper{background:#101018}
.booking-form{background:#101018}
.footer{background:#08080c}
.whatsapp-float{box-shadow:0 0 30px rgba(37,211,102,.3)}`,
  },
};
...
export function renderWebsite(c) {
  ...
  const p = { ...(PALETTES[c.businessType] || PALETTES.default), ...(COLOR_STYLES[c.colorStyle] || {}) };
  const icon = ICONS[c.businessType] || ICONS.default;
  const wa = (biz.whatsapp || '60123456789').replace(/\D/g, '');
  const th = THEMES[c.theme] || THEMES.modern;
  const en = c.language === 'en';
  const L = en ? {
    home:'Home', about:'About', menu:'Menu', gallery:'Gallery', booking:'Booking', contact:'Contact',
    bookNow:'Book Now', contactUs:'Contact Us', years:'Years Experience', customers:'Happy Customers',
    rating:'Rating', order:'Order', aboutUs:'About Us', viewMenu:'View Our Menu',
    sigTag:'Signature', sigTitle:'Must-Try Dishes', sigSub:'Our two iconic dishes that keep customers coming back',
    menuTag:'Our Menu', menuTitle:'Variety of Specialties', menuSub:'Explore our diverse menu',
    galTitle:'Beauty & Ambiance', galSub:'See our uniqueness for yourself',
    featTitle:'Why Choose Us',
    testTitle:'What Our Customers Say',
    bookTag:'Reservation', bookTitle:'Book Your Table', bookInfo:'Booking <span style="color:var(--gold)">Info</span>',
    bookInfoSub:'Fill the form or contact us via WhatsApp.',
    monThu:'Monday - Thursday', friSun:'Friday - Sunday', phone:'Phone',
    formTitle:'Booking Form', formSub:'Complete the information below.',
    name:'Full Name *', phoneNo:'Phone No. *', date:'Date *', time:'Time *', pax:'Number of Guests *',
    seating:'Seating Type', notes:'Special Requests', submit:'Send Booking',
    choosePax:'Choose', regular:'Regular', outdoor:'Outdoor',
    contTag:'Contact Us', contTitle:'Location & Info',
    address:'Address', email:'Email', ctaTitle:'Craving It Already?',
    ctaText:'Contact us now for the best experience!', ctaBtn:'Book Now', ctaBtn2:'Contact Us',
    quickLinks:'Quick Links', hours:'Operating Hours', copyright:'All Rights Reserved.',
    waOrder:(n)=>'I want to order ' + (n||''),
    waBook:'I want to make a table booking. Thank you!',
    sentMsg:'Booking sent! Redirecting to WhatsApp...', fillAll:'Please complete all required fields.',
    trialNote:'Starts from', successTitle:'Success', errTitle:'Error',
    cats:{utama:'Main Dishes', minuman:'Beverages', pencuci:'Desserts'},
  } : {
    home:'Utama', about:'Tentang', menu:'Menu', gallery:'Galeri', booking:'Tempahan', contact:'Hubungi',
    bookNow:'Tempah Sekarang', contactUs:'Hubungi Kami', years:'Tahun Pengalaman', customers:'Pelanggan Gembira',
    rating:'Penilaian', order:'Order', aboutUs:'Tentang Kami', viewMenu:'Lihat Menu Kami',
    sigTag:'Menu Signatur', sigTitle:'Hidangan Wajib Cuba', sigSub:'Dua hidangan ikonik kami yang menjadi tarikan utama',
    menuTag:'Menu Pilihan', menuTitle:'Pelbagai Hidangan Istimewa', menuSub:'Jelajahi menu kami yang pelbagai',
    galTitle:'Keindahan & Suasana', galSub:'Lihat sendiri keunikan kami',
    featTitle:'Mengapa Pilih Kami',
    testTitle:'Apa Kata Pelanggan Kami',
    bookTag:'Tempahan', bookTitle:'Tempah Meja Anda', bookInfo:'Maklumat <span style="color:var(--gold)">Tempahan</span>',
    bookInfoSub:'Sila isi borang di sebelah atau hubungi kami melalui WhatsApp.',
    monThu:'Isnin - Khamis', friSun:'Jumaat - Ahad', phone:'Telefon',
    formTitle:'Borang Tempahan', formSub:'Sila lengkapkan maklumat di bawah.',
    name:'Nama Penuh *', phoneNo:'No. Telefon *', date:'Tarikh *', time:'Masa *', pax:'Bilangan Orang *',
    seating:'Jenis Tempat Duduk', notes:'Catatan Khas', submit:'Hantar Tempahan',
    choosePax:'Pilih', regular:'Biasa', outdoor:'Luar',
    contTag:'Hubungi Kami', contTitle:'Lokasi & Maklumat',
    address:'Alamat', email:'Email', ctaTitle:'Teringin Mencuba?',
    ctaText:'Hubungi kami sekarang untuk pengalaman terbaik!', ctaBtn:'Tempah Sekarang', ctaBtn2:'Hubungi Kami',
    quickLinks:'Pautan Pantas', hours:'Waktu Operasi', copyright:'Hak Cipta Terpelihara.',
    waOrder:(n)=>'Saya nak order ' + (n||''),
    waBook:'Saya nak membuat tempahan meja. Terima kasih!',
    sentMsg:'Tempahan dihantar! Dialihkan ke WhatsApp...', fillAll:'Sila lengkapkan semua medan yang diperlukan.',
    trialNote:'Mulai Harga', successTitle:'Berjaya', errTitle:'Ralat',
    cats:{utama:'Makanan Utama', minuman:'Minuman', pencuci:'Pencuci Mulut'},
  };
  ...
  const menuCards = (c.menu || []).map((m, i) => {
    ...
    return `<article class="menu-card${cat === 'utama' ? ' show' : ''}" data-category="${esc(cat)}">
      ...
      <a href="https://wa.me/${wa}?text=${encodeURIComponent(L.waOrder(m.name))}" class="btn-order" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> Order</a></div></div></article>`;
  }).join('\n');
    ...
    <div class="signature-card reveal">
      ...
      <div class="signature-card-content">
        ...
        <div class="signature-card-footer">
          ...
          <a href="https://wa.me/${wa}?text=${encodeURIComponent(L.waOrder(s.name))}" class="btn-order" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> Order</a>
        </div>
      </div>
    </div>`).join('\n');
  ...
  const faqItems = (c.faq || []).map((f, i) => `
    <div class="faq-item${i === 0 ? ' open' : ''}" onclick="this.classList.toggle('open')">
      <div class="faq-q">${esc(f.q)} <i class="fas fa-chevron-down"></i></div>
...
<link href="${th.fontLinks}" rel="stylesheet">
...
<style>
:root{--primary:${p.primary};--primary-light:${p.primaryLight};--secondary:${p.secondary};--accent:${p.accent};--accent-dark:${p.accent};--bg-light:${p.bgLight};--bg-white:#fff;--text-dark:${th.textDark};--text-muted:${th.textMuted};--gold:${p.gold};--gradient-main:linear-gradient(135deg,${p.primary} 0%,${p.secondary} 100%);--gradient-accent:linear-gradient(135deg,${p.secondary} 0%,${p.accent} 100%);--gradient-hero:${th.heroOverlay || 'linear-gradient(135deg,rgba(0,0,0,.75) 0%,rgba(0,0,0,.5) 50%,rgba(0,0,0,.35) 100%)'};--shadow-sm:0 4px 12px rgba(0,0,0,.08);--shadow-md:0 8px 24px rgba(0,0,0,.12);--shadow-lg:0 20px 50px rgba(0,0,0,.18);--shadow-glow:0 10px 40px ${p.primary}66;--transition:.3s cubic-bezier(.4,0,.2,1);--radius-sm:12px;--radius-md:20px;--radius-lg:30px}
*{margin:0;padding:0;box-sizing:border-box}
html{scroll-behavior:smooth;scroll-padding-top:80px}
body{font-family:${th.fonts.body};color:var(--text-dark);background:var(--bg-light);line-height:1.6;overflow-x:hidden}
h1,h2,h3,h4{font-family:${th.fonts.head};line-height:1.2;color:var(--accent)}
.container{max-width:1280px;margin:0 auto;padding:0 24px}
.navbar{position:fixed;top:0;left:0;width:100%;z-index:1000;padding:18px 0;background:${th.navbarBg};backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-bottom:1px solid rgba(0,0,0,.06);transition:var(--transition)}
...
/* FAQ */
.faq-item{background:var(--bg-white,#fff);border:1px solid var(--border,#eee);border-radius:var(--radius-sm,12px);margin-bottom:12px;overflow:hidden;cursor:pointer;transition:var(--transition,.3s)}
.faq-item:hover{box-shadow:var(--shadow-sm)}
.faq-q{padding:18px 22px;font-weight:600;font-size:.95rem;color:var(--accent);display:flex;align-items:center;justify-content:space-between;gap:12px}
.faq-q i{transition:transform .3s;font-size:.8rem;color:var(--secondary)}
.faq-a{max-height:0;overflow:hidden;transition:max-height .4s ease,padding .4s ease;color:var(--text-muted);font-size:.88rem;line-height:1.7}
.faq-item.open .faq-a{max-height:300px;padding:0 22px 18px}
.faq-item.open .faq-q i{transform:rotate(180deg)}
/* Counter */
.stat-counter{font-variant-numeric:tabular-nums}
/* Contact quick form */
.quick-contact{background:var(--bg-white,#fff);border-radius:var(--radius-md,20px);padding:32px;box-shadow:var(--shadow-md)}
.quick-contact h3{font-size:1.3rem;margin-bottom:8px}
.quick-contact input,.quick-contact textarea{width:100%;padding:12px 16px;border:2px solid var(--bg-light,#f5f5f5);border-radius:10px;font-family:inherit;font-size:.9rem;margin-bottom:12px;background:var(--bg-light,#f8f8f8);transition:var(--transition,.3s)}
.quick-contact input:focus,.quick-contact textarea:focus{outline:none;border-color:var(--primary);background:#fff}
.quick-contact textarea{min-height:90px;resize:vertical}
/* Marquee hero scroll hint */
.scroll-hint{position:absolute;bottom:24px;left:50%;transform:translateX(-50%);color:#fff;opacity:.7;font-size:.75rem;letter-spacing:2px;text-transform:uppercase;animation:bounce 2s infinite}
@keyframes bounce{0%,100%{transform:translateX(-50%) translateY(0)}50%{transform:translateX(-50%) translateY(-8px)}}
/* Feature icon float */
@keyframes floatIcon{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}
.feature-icon{animation:floatIcon 3s ease-in-out infinite}
${th.extraCss}
...
<li><a href="#home">${L.home}</a></li><li><a href="#about">${L.about}</a></li><li><a href="#menu">${L.menu}</a></li><li><a href="#gallery">${L.gallery}</a></li><li><a href="#booking">${L.booking}</a></li><li><a href="#contact">${L.contact}</a></li>
...
<a href="#booking" class="btn btn-primary"><i class="fas fa-calendar-check"></i> ${L.bookNow}</a>
<a href="https://wa.me/${wa}" class="btn btn-secondary" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> ${L.contactUs}</a>
</div>
<div class="hero-stats">
<div class="hero-stat"><strong>${esc((c.stats && c.stats[0]) || '10+')}</strong><span>${L.years}</span></div>
<div class="hero-stat"><strong>${esc((c.stats && c.stats[1]) || '5K+')}</strong><span>${L.customers}</span></div>
<div class="hero-stat"><strong>${esc((c.stats && c.stats[2]) || '4.9★')}</strong><span>${L.rating}</span></div>
</div>
</div>
...
<div class="hero-card-row"><div class="hero-card-price">${esc(c.heroCard.price)}<small>${esc(c.heroCard.priceNote || L.trialNote)}</small></div>
<a href="https://wa.me/${wa}?text=${encodeURIComponent(L.waOrder(c.heroCard.name))}" class="btn-order" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> Order</a></div>
</div>` : ''}
</div></header>
...
<div class="about-floating"><i class="fas fa-award"></i><div><strong>${esc((c.stats && c.stats[0]) || '10+')}</strong><span>${L.years}</span></div></div>
</div>
<div class="about-content reveal">
<div class="section-tag">${L.aboutUs}</div>
...
<a href="#menu" class="btn btn-gradient"><i class="fas fa-book-open"></i> ${L.viewMenu}</a>
</div>
</div></div></section>

<section class="section signature" id="signature"><div class="container">
<div class="section-header reveal"><div class="section-tag">${L.sigTag}</div><h2>${L.sigTitle}</h2><p>${L.sigSub}</p></div>
<div class="signature-grid">${sigCards}</div>
</div></section>

<section class="section menu" id="menu"><div class="container">
<div class="section-header reveal"><div class="section-tag">${L.menuTag}</div><h2>${L.menuTitle}</h2><p>${L.menuSub}</p></div>
...
<div class="section-header reveal"><div class="section-tag">${L.gallery}</div><h2>${L.galTitle}</h2><p>${L.galSub}</p></div>
<div class="gallery-grid reveal">${gallery}</div>
</div></section>

<section class="section features"><div class="container">
<div class="section-header reveal"><div class="section-tag">Kelebihan Kami</div><h2>${L.featTitle.replace('Kami', name)}</h2></div>
<div class="features-grid">${features}</div>
</div></section>

<section class="section testimonials" id="testimonials"><div class="container">
<div class="section-header reveal"><div class="section-tag">Testimoni</div><h2>${L.testTitle}</h2></div>
<div class="testimonials-grid">${testimonials}</div>
</div></section>

${faqItems ? `<section class="section" id="faq" style="background:var(--bg-white,#fff)"><div class="container">
<div class="section-header reveal"><div class="section-tag">FAQ</div><h2>${en ? 'Frequently Asked Questions' : 'Soalan Lazim'}</h2></div>
<div style="max-width:760px;margin:0 auto">${faqItems}</div>
</div></section>` : ''}

<div class="quick-contact reveal" style="max-width:520px;margin:0 auto 60px;padding:32px" id="quickmsg">
<h3>${en ? 'Quick Enquiry' : 'Pertanyaan Pantas'}</h3>
<p style="font-size:.85rem;color:var(--text-muted);margin-bottom:16px">${en ? 'Any question? Send us a message — we reply fast!' : 'Ada soalan? Hantar mesej — kami balas pantas!'}</p>
<input type="text" id="qcName" placeholder="${en ? 'Your name' : 'Nama anda'}"/>
<textarea id="qcMsg" placeholder="${en ? 'Your message...' : 'Mesej anda...'}"></textarea>
<button class="btn btn-gradient" style="width:100%;justify-content:center" onclick="sendQuickMsg()"><i class="fab fa-whatsapp"></i> ${en ? 'Send via WhatsApp' : 'Hantar via WhatsApp'}</button>
</div>

<section class="section booking" id="booking"><div class="container">
<div class="section-header reveal"><div class="section-tag">${L.bookTag}</div><h2>${L.bookTitle}</h2></div>
<div class="booking-wrapper reveal">
<div class="booking-info">
<h2>${L.bookInfo}</h2>
<p>${L.bookInfoSub}</p>
<ul class="booking-hours">
<li><span><i class="fas fa-clock"></i> ${L.monThu}</span><span>11:00 AM - 10:00 PM</span></li>
<li><span><i class="fas fa-clock"></i> ${L.friSun}</span><span>11:00 AM - 11:00 PM</span></li>
<li><span><i class="fas fa-phone"></i> ${L.phone}</span><span>${esc(biz.phone || '012-345 6789')}</span></li>
<li><span><i class="fab fa-whatsapp"></i> WhatsApp</span><span>${esc(biz.phone || '011-2567 0105')}</span></li>
</ul>
</div>
<div class="booking-form">
<h3>${L.formTitle}</h3><p>${L.formSub}</p>
<div class="form-message" id="formMessage"><i class="fas fa-check-circle"></i><span id="formMessageText"></span></div>
<form id="bookingForm" novalidate>
<div class="form-row">
<div class="form-group"><label for="name">${L.name}</label><input type="text" id="name" placeholder="${en ? 'Your name' : 'Nama anda'}" required><div class="form-error">Sila masukkan nama anda</div></div>
<div class="form-group"><label for="phone">${L.phoneNo}</label><input type="tel" id="phone" placeholder="012-3456789" required><div class="form-error">Sila masukkan nombor yang sah</div></div>
</div>
<div class="form-row">
<div class="form-group"><label for="date">${L.date}</label><input type="date" id="date" required><div class="form-error">Sila pilih tarikh</div></div>
<div class="form-group"><label for="time">${L.time}</label><input type="time" id="time" required><div class="form-error">Sila pilih masa</div></div>
</div>
<div class="form-row">
<div class="form-group"><label for="pax">${L.pax}</label><select id="pax" required><option value="">${L.choosePax}</option><option>1-2 orang</option><option>3-4 orang</option><option>5-8 orang</option><option>9-12 orang</option><option>12+ orang</option></select><div class="form-error">Sila pilih bilangan</div></div>
<div class="form-group"><label for="seating">Tempat Duduk</label><select id="seating"><option>${L.regular}</option><option>${L.outdoor}</option><option>VIP</option></select></div>
</div>
<div class="form-group"><label for="notes">${L.notes}</label><textarea id="notes" placeholder="${L.notes.replace(' *','')}..."></textarea></div>
<button type="submit" class="btn-submit"><i class="fas fa-paper-plane"></i> ${L.submit}</button>
</form>
</div>
</div>
</div></section>
...
<div class="section-header reveal"><div class="section-tag">${L.contTag}</div><h2>${L.contTitle}</h2></div>
<div class="contact-grid">
<div class="reveal">
<div class="contact-cards">
<div class="contact-card"><i class="fas fa-map-marker-alt"></i><h4>${L.address}</h4><p>${esc(biz.address || biz.location || 'Malaysia')}</p></div>
<div class="contact-card"><i class="fas fa-phone-alt"></i><h4>${L.phone}</h4><a href="tel:${esc((biz.phone || '').replace(/\\D/g, ''))}">${esc(biz.phone || '012-345 6789')}</a></div>
...
<div class="contact-card"><i class="fas fa-envelope"></i><h4>${L.email}</h4><a href="mailto:${esc(biz.email || 'info@example.com')}">${esc(biz.email || 'info@example.com')}</a></div>
</div>
...
<h2 class="reveal">${esc(c.ctaTitle || L.ctaTitle)}</h2>
<p class="reveal">${esc(c.ctaText || L.ctaText)}</p>
<div class="cta-buttons reveal">
<a href="https://wa.me/${wa}" class="btn btn-primary" target="_blank" rel="noopener"><i class="fab fa-whatsapp"></i> ${L.ctaBtn}</a>
<a href="tel:${esc((biz.phone || '').replace(/\\D/g, ''))}" class="btn btn-secondary"><i class="fas fa-phone"></i> ${L.ctaBtn2}</a>
</div>
</div></section>
...
<div class="footer-bottom"><p>&copy; 2026 <strong>${name}</strong>. ${L.copyright}</p></div>
</div></footer>
...
if(!ok){msg.className='form-message show error';msgText.textContent=L.fillAll;setTimeout(()=>msg.classList.remove('show'),3000);return}
const m='${L.waBook}${name}\\nNama: '+v('name')+'\\nTelefon: '+v('phone')+'\\nTarikh: '+v('date')+'\\nMasa: '+v('time')+'\\nBilangan: '+v('pax')+'\\nCatatan: '+(v('notes')||'-');
msg.className='form-message show success';msgText.textContent=L.sentMsg;
...
function sendQuickMsg(){const n=document.getElementById('qcName').value.trim()||'-',m=document.getElementById('qcMsg').value.trim();if(!m){alert('${en ? 'Please type your message' : 'Sila tulis mesej anda'}');return}const t=encodeURIComponent('${en ? 'Hi! Enquiry from ' : 'Salam! Pertanyaan dari '}'+n+'\\n\\n'+m);window.open('https://wa.me/${wa}?text='+t,'_blank')}
document.querySelectorAll('.hero-stat strong').forEach(el=>{const raw=el.textContent;const num=parseFloat(raw.replace(/[^\\d.]/g,''));if(!num||isNaN(num))return;const suffix=raw.replace(/[\\d.,]/g,'');let cur=0;const steps=40;const inc=num/steps;const timer=setInterval(()=>{cur+=inc;if(cur>=num){cur=num;clearInterval(timer)}el.textContent=(num%1?cur.toFixed(1):Math.round(cur))+suffix},30)});
console.log('%c✨ ${name}', 'font-size:16px;font-weight:bold;color:${p.primary}');</script>
</body>
</html>`;
}
